...
from Facerec_QT.anchors import ANCHOR
...
def clear_db(db_path = 'resources/database.db'):
...
class FaceRecognition():
    ...
    def __init__(self, threshold, image_height, image_width):
        self.fd_model = NetworkExecutor("/home/mrson/Control_Robot/robot_rasberry_test/robot_raspberry/video_processing/Facerec_QT/face_rec_models/ulffd_landmark.tflite", preprocess_for_fd)
        self.fe_model = NetworkExecutor("/home/mrson/Control_Robot/robot_rasberry_test/robot_raspberry/video_processing/Facerec_QT/face_rec_models/inference_model_993.tflite", preprocess_for_fe)
    ...
    def load_db(self):
        self.db = read_db("/home/mrson/Control_Robot/robot_rasberry_test/robot_raspberry/video_processing/Facerec_QT/resources/database.db")
